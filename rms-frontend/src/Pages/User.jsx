...
const User = () => {
  ...
  const addData = () => {
    if (
      ...
      axios.post(`${URL}/users`, body).then((response) => {
        const result = response.data;
  ...
  const updateData = () => {
    ...
    axios.put(`${URL}/users/${userId}`, body).then((response) => {
      const result = response.data;
      if (result["status"] == "success") {
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title fs-3 fw-bold" id="exampleModalLabel">
                  Add User
                </h5>
                <button
                  type="button"
                  ...
                  return (
                    <tr key={usr.userId}>
                      <td scope="col">
                        <img
                          className="usrImg"
                          src={`${URL}/users/image/${usr.profileImage}`}
                        ></img>
                      </td>
                      ...
                      <td>
                        ...
                        {currentUserId != usr.userId && (
                          <button
                            onClick={deleteData.bind(this, usr.userId)}
