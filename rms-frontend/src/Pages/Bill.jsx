...
const Bill = () => {
  ...
  const sumOfAmount = (tax) => {
    var table = document.getElementById("ordtableid"),
      sumVal = 0;
                  ...
                  <tbody>
                    ...
                    {billById.billTotal == 0 ? (
                      <tr>
                        <td colspan="3">
                          <button
                            onClick={sumOfAmount.bind(
                              this,
                              billById.taxAndCharge
                            )}
                            type="button"
                  ...
                  return (
                    <tr key={bill.billId}>
                      ...
                      <td>
                        ...
                        <button
                          onClick={deleteBill.bind(this, bill.billId)}
